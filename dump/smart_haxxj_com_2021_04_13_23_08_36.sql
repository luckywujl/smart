...
INSERT INTO `smart_admin` VALUES (1,'admin','Admin','b35720a9ca24e6aa1b2f87218c6acb31','6a4f25','/uploads/20210413/489af80e5c10bebbe303f58cf14f5529.jpg','admin@admin.com',0,1618324502,'127.0.0.1',1491635035,1618324502,'85e707d3-acd4-4019-b90b-abe854cc0379','normal'),(2,'1001','企业管理员','5be24d43dcb65f13ac668715d16a255d','8DWZ30','/uploads/20210413/961bed67300fefec24cb5b65b2343cb6.jpg','1001@qq.com',0,1618323222,'127.0.0.1',1618242691,1618324498,'','normal');
...
CREATE TABLE `smart_admin_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=159 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='管理员日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `smart_vote_player` VALUES (1,1,1,0,1,'A方案（自筹资金）','一单元业主承担','相关费用由一单元62户业主承担','/uploads/20210411/acfe2a6af3faf001821ef7a02c3b4bcf.jpg','','',1,6,1,'[]',1618146374,1618150011,1618146511,'','normal'),(2,1,1,0,2,'B方案（公共维修基金）','申请公众维修基金用于维修','申请公众维修基金用于维修','/uploads/20210411/b498dab6d5a9df523c56fbdaaaa75e69.jpg','','',0,1,0,'[]',1618146410,1618149995,1618146376,'','normal'),(3,2,0,1,1,'吴俊雷','吴俊雷任沤鸿物业管理部经理，工作兢兢业业，任劳任怨。对待业主为人和气，主动为业主排忧解难。','吴俊雷任沤鸿物业管理部经理，工作兢兢业业，任劳任怨。对待业主为人和气，主动为业主排忧解难。','/uploads/20210411/45b791433ba99f3b36c389c7db184ae8.jpg','','',6,7,2,'[]',1618151191,1618323302,1618323302,'','normal');
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='投票记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-04-13 23:08:37
