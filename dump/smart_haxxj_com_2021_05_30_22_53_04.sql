...
INSERT INTO `smart_admin` VALUES (1,'admin','Admin','b35720a9ca24e6aa1b2f87218c6acb31','6a4f25','/uploads/20210413/489af80e5c10bebbe303f58cf14f5529.jpg','admin@admin.com',0,1622378458,'127.0.0.1',1491635035,1622378458,'bf788824-6d80-4d94-9064-c327a6450f2f','normal'),(2,'1001','企业管理员','5be24d43dcb65f13ac668715d16a255d','8DWZ30','/uploads/20210413/961bed67300fefec24cb5b65b2343cb6.jpg','1001@qq.com',0,1622037501,'127.0.0.1',1618242691,1622037501,'a5f0c0a3-7b5a-4488-ad85-6523b60ff954','normal');
...
CREATE TABLE `smart_admin_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=302 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='管理员日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='开门记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `smart_door_record` VALUES (5,'1','admin',1622048136,NULL,'请求开门','0'),(6,'1','admin',1622048189,NULL,'请求开门','0'),(7,'1','admin',1622048214,NULL,'请求开门','0'),(8,'1','admin',1622048274,NULL,'请求开门','0'),(9,'1','admin',1622048295,NULL,'请求开门','0'),(10,'1','admin',1622048564,NULL,'请求开道闸','0'),(12,'4','admin',1622378655,NULL,'请求开门','0'),(13,'1','admin',1622378715,NULL,'请求开门','0'),(14,'9','admin',1622382125,NULL,'请求开道闸','0'),(15,'10','admin',1622382136,NULL,'请求开道闸','0');
...
INSERT INTO `smart_user` VALUES (7,0,'admin','业主','8b4ad3e40e4223bd7f56d847a73a102b','d8PKil','99@qq.com','13801409049','/uploads/20210412/45b791433ba99f3b36c389c7db184ae8.jpg',0,1,'2021-04-12','这家伙太懒，只留下冒着热气的大',0.00,0,1,2,1621866884,1622378645,'192.168.0.100',0,'0',1618242245,1618242247,1622378645,'','normal','','星雨华府5号楼306','无');
...
INSERT INTO `smart_user_token` VALUES ('71d8e5a3dd497c33e065b4f422bfe9ed80a6d407',7,1621866884,1624458884),('9d66fe99042ff90b0fdd172c79be3035f94d974a',7,1621783058,1624375058),('fbab6c63b4773671e572568544e263d14d59bfd9',7,1622378645,1624970645);
...
-- Dump completed on 2021-05-30 22:53:05
