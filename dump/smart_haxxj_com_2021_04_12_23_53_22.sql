...
INSERT INTO `smart_admin` VALUES (1,'admin','Admin','b35720a9ca24e6aa1b2f87218c6acb31','6a4f25','/assets/img/avatar.png','admin@admin.com',0,1618237194,'127.0.0.1',1491635035,1618242696,'','normal'),(2,'1001','企业管理员','5be24d43dcb65f13ac668715d16a255d','8DWZ30','/assets/img/avatar.png','1001@qq.com',0,1618242699,'127.0.0.1',1618242691,1618242699,'c4cec706-1a62-49bf-9239-a4489aeecbab','normal');
...
CREATE TABLE `smart_admin_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='管理员日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `smart_user` VALUES (7,0,'admin','业主','8b4ad3e40e4223bd7f56d847a73a102b','d8PKil','99@qq.com','13801409049','/uploads/20210412/45b791433ba99f3b36c389c7db184ae8.jpg',0,1,'2021-04-12','这家伙太懒，只留下冒着热气的大便',0.00,0,0,0,1618242241,1618242261,'127.0.0.1',0,'0',1618242245,1618242247,1618242733,'','normal','','星雨华府5号楼306','无');
...
INSERT INTO `smart_user_token` VALUES ('4936edfa797b191e64d5b2366a8239a7ae7bc909',7,1618242261,1620834261);
...
INSERT INTO `smart_vote_player` VALUES (1,1,1,0,1,'A方案（自筹资金）','一单元业主承担','相关费用由一单元62户业主承担','/uploads/20210411/acfe2a6af3faf001821ef7a02c3b4bcf.jpg','','',1,6,1,'[]',1618146374,1618150011,1618146511,'','normal'),(2,1,1,0,2,'B方案（公共维修基金）','申请公众维修基金用于维修','申请公众维修基金用于维修','/uploads/20210411/b498dab6d5a9df523c56fbdaaaa75e69.jpg','','',0,1,0,'[]',1618146410,1618149995,1618146376,'','normal'),(3,2,0,1,1,'吴俊雷','吴俊雷任沤鸿物业管理部经理，工作兢兢业业，任劳任怨。对待业主为人和气，主动为业主排忧解难。','吴俊雷任沤鸿物业管理部经理，工作兢兢业业，任劳任怨。对待业主为人和气，主动为业主排忧解难。','/uploads/20210411/45b791433ba99f3b36c389c7db184ae8.jpg','','',4,4,1,'[]',1618151191,1618152709,1618152709,'','normal');
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='投票记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `smart_vote_record` VALUES (1,1,1,1,'127.0.0.1',1618146511,1618146511),(2,1,2,3,'127.0.0.1',1618151217,1618151217),(3,1,2,3,'127.0.0.1',1618151244,1618151244),(4,1,2,3,'192.168.0.101',1618152706,1618152706),(5,1,2,3,'192.168.0.101',1618152708,1618152708);
...
-- Dump completed on 2021-04-12 23:53:22
