...
INSERT INTO `smart_admin` VALUES (1,'admin','Admin','b35720a9ca24e6aa1b2f87218c6acb31','6a4f25','/uploads/20210413/489af80e5c10bebbe303f58cf14f5529.jpg','admin@admin.com',0,1618302450,'127.0.0.1',1491635035,1618302450,'c1fac1e1-e857-46fc-8ff9-9a6084fde1a1','normal'),(2,'1001','企业管理员','5be24d43dcb65f13ac668715d16a255d','8DWZ30','/uploads/20210413/961bed67300fefec24cb5b65b2343cb6.jpg','1001@qq.com',0,1618302231,'127.0.0.1',1618242691,1618302445,'','normal');
...
CREATE TABLE `smart_admin_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=146 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='管理员日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `smart_auth_rule` (
  ...
  KEY `pid` (`pid`),
  KEY `weigh` (`weigh`)
) ENGINE=InnoDB AUTO_INCREMENT=180 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='节点表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `smart_question_info` (
  ...
  `question_person` varchar(45) DEFAULT NULL COMMENT '反映人',
  `question_person_tel` varchar(45) DEFAULT NULL COMMENT '联系电话',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='反馈问题';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `smart_user` VALUES (7,0,'admin','业主','8b4ad3e40e4223bd7f56d847a73a102b','d8PKil','99@qq.com','13801409049','/uploads/20210412/45b791433ba99f3b36c389c7db184ae8.jpg',0,1,'2021-04-12','这家伙太懒，只留下冒着热气的大便',0.00,0,1,1,1618302553,1618302763,'127.0.0.1',0,'0',1618242245,1618242247,1618302763,'','normal','','星雨华府5号楼306','无');
...
INSERT INTO `smart_user_token` VALUES ('0d964ffcc208f58309e774183b16d4c9b6ec0ea4',7,1618302763,1620894763),('4936edfa797b191e64d5b2366a8239a7ae7bc909',7,1618242261,1620834261);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='投票评论表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `smart_vote_comment` VALUES (1,1,1,1,'','还可以这么搞吗？','127.0.0.1',1618147553,1618147568,'normal'),(2,2,3,1,NULL,'真漂亮的小姐姐','192.168.0.101',1618152725,1618152725,'hidden');
...
INSERT INTO `smart_vote_player` VALUES (1,1,1,0,1,'A方案（自筹资金）','一单元业主承担','相关费用由一单元62户业主承担','/uploads/20210411/acfe2a6af3faf001821ef7a02c3b4bcf.jpg','','',1,6,1,'[]',1618146374,1618150011,1618146511,'','normal'),(2,1,1,0,2,'B方案（公共维修基金）','申请公众维修基金用于维修','申请公众维修基金用于维修','/uploads/20210411/b498dab6d5a9df523c56fbdaaaa75e69.jpg','','',0,1,0,'[]',1618146410,1618149995,1618146376,'','normal'),(3,2,0,1,1,'吴俊雷','吴俊雷任沤鸿物业管理部经理，工作兢兢业业，任劳任怨。对待业主为人和气，主动为业主排忧解难。','吴俊雷任沤鸿物业管理部经理，工作兢兢业业，任劳任怨。对待业主为人和气，主动为业主排忧解难。','/uploads/20210411/45b791433ba99f3b36c389c7db184ae8.jpg','','',5,4,1,'[]',1618151191,1618305847,1618305847,'','normal');
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='投票记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `smart_vote_record` VALUES (1,1,1,1,'127.0.0.1',1618146511,1618146511),(2,1,2,3,'127.0.0.1',1618151217,1618151217),(3,1,2,3,'127.0.0.1',1618151244,1618151244),(4,1,2,3,'192.168.0.101',1618152706,1618152706),(5,1,2,3,'192.168.0.101',1618152708,1618152708),(6,7,2,3,'127.0.0.1',1618305847,1618305847);
...
-- Dump completed on 2021-04-13 17:37:06
