...
class Subject extends Model
{
    ...
    protected static function init()
    {
        ...
        $refresh = function ($subject_id) {
            ...
            $applyfield = request()->post("applyfield/a", [], 'trim,xss_clean');
            $data = [];
    ...
    public static function getSubjectFields($subject_id, $player = null, $conditions = [])
    {
