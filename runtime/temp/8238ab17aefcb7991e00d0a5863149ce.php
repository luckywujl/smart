                ...
                <div class="panel panel-default panel-user">
                    <div class="panel-body">
                        <div class="page-header panel-post">
                            ...
                            <a href="<?php echo url('index/vote/post'); ?>" class="btn btn-info btn-post"><i class="fa fa-edit"></i> 创建新的投票</a>
                        </div>
                        <?php if(is_array($subjectList) || $subjectList instanceof \think\Collection || $subjectList instanceof \think\Paginator): $i = 0; $__LIST__ = $subjectList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                        <div class="row">
                            <div class="col-md-3 text-center">
                                <div style="padding:15px;">
                                    <a href="<?php echo $item['url']; ?>">
                                        <img class="img-responsive img-border" src="<?php echo $item['image']; ?>" onerror="this.src='/assets/addons/vote/img/noimage.jpg';this.onerror=null;">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-9">
                                ...
                                <div>
                                    ...
                                    <a class="btn btn-success" href="<?php echo $item['url']; ?>" target="_blank"><i class="fa fa-home"></i> 立即查看</a>
                                    <?php elseif($item['status'] == 'rejected'): ?>
                                    <a class="btn btn-danger" href="<?php echo url('index/vote/post'); ?>?id=<?php echo $item['id']; ?>" data-toggle="tooltip" title="<?php echo $item['memo']; ?>"><i class="fa fa-pencil"></i> 被拒绝</a>
                                    <a class="btn btn-success" href="<?php echo $item['url']; ?>"><i class="fa fa-eye-slash"></i> 投票预览</a>
                                    <?php elseif($item['status'] == 'hidden'): ?>
                                    <a class="btn btn-info" href="<?php echo url('index/vote/post'); ?>?id=<?php echo $item['id']; ?>" data-toggle="tooltip" title="请耐心等待后台审核,审核前你可以继续修改"><i class="fa fa-pencil"></i> 正在审核</a>
                                    <a class="btn btn-success" href="<?php echo $item['url']; ?>"><i class="fa fa-eye-slash"></i> 投票预览</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="text-center"><?php echo $subjectList->isEmpty()?"暂未创建任何投票":""; ?></div>
                        <div class="pager"><?php echo $subjectList->render(); ?></div>
                    </div>
                </div>
            </div>
        </div>
