            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'question_person', title: __('Question_person'), operate: 'LIKE'},
                        {field: 'question_person_tel', title: __('Question_person_tel'), operate: 'LIKE'},
                        {field: 'question_type', title: __('Question_type'), operate: 'LIKE'},
                        {field: 'question_datetime', title: __('Question_datetime'), operate: 'LIKE'},
                        {field: 'question_files', title: __('Question_files'), operate: false},
